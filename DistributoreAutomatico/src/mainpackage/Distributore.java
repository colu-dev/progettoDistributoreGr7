...
public class Distributore{
	...
	public static Prodotti prodotto1 = new Prodotti("coca-cola",2.00,10,true,0);
	public static Prodotti prodotto2 = new Prodotti("fanta",2.00,10,true,0);
	public static Prodotti prodotto3 = new Prodotti("caffe",1.00,10,true,0);
	public static Prodotti prodotto4 = new Prodotti("acqua",0.70,10,true,0);
	public static Prodotti prodotto5 = new Prodotti("thè",2.00,10,true,0);
	public static Prodotti prodotto6 = new Prodotti("birra",2.30,10,true,0);
	public static Prodotti prodotto7 = new Prodotti("campari soda",2.50,10,true,0);
	public static Prodotti prodotto8 = new Prodotti("molinari",1.50,10,true,0);
	public static Prodotti prodotto9 = new Prodotti("grappino",1.50,10,true,0);
	...
	public void aggiungiProdotto(String nome, double prezzo, int quantita) {
		...
		bevande.add(new Prodotti(nome,prezzo,quantita,true,0));
